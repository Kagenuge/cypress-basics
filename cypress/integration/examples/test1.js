...
describe('my first test suite', function () {
  ...
  it('types, searches, and then displays 2 search results, which is cucumber and capsicum and adds capsicum to the cart', function () {
  ...
  it('clicks cart icon and proceeds to checkout', function () {
